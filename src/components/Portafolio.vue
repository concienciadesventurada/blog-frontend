...
const absolutePixel = {
  nombre: "absolutepixel",
  fecha: "Jul-Aug 2022",
  estado: "Archived",
  descripcion: "A 2D Game Engine written in modern C++ powered by SDL2 API.",
  puntos: [
...
const freqTab = {
  ...
  fecha: "May-July - 2022",
  estado: "Archived",
  descripcion: "Exploratory project for R, RStudio, and package making.",
  puntos: [
...
const fedoraHapless = {
  ...
  techStack: [
    { icon: FedoraIcon, title: "Fedora Linux" },
    { icon: GnubashIcon, title: "Bash" },
  ]
}
